...
public class TechProStepDefinition1 {
    TechproPage techproPage = new TechproPage();//Class seviyesinde de olusturabiliriz.
    //o zaman her test icinde constructor olusturmaya gerek kalmaz
